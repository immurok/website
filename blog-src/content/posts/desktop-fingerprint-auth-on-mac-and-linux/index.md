...
If your desk is one of the awkward setups above, that's exactly who I built it for. The macOS app, PAM module, and Linux app are [on GitHub](https://github.com/immurok); if you want to try the device before launch, [join the waitlist](/#pricing).
